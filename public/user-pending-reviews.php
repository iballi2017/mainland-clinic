            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-lg-8" id="order-history">
                    <div class="border-accent-50 border rounded-250 px-3 pt-4 pb-5">
                        <h2 class="fw-semi-bold fs-300 border-bottom border-accent-50 pb-3">Pending reviews</h2>
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card-body">
                                                <ul class="prod-info | list-style-none ps-0 mb-0" role="list">
                                                    ...
                                                    <li class="tag completed">Delivered</li>
                                        ...
                                        <div class="col-md-3">
                                            <div class="align-lg-right px-3 pb-3 py-lg-3">
                                                <a href="./user-rate-item.php?title=Combo 10 urine stripe" class="text-primary-500 fs-50 text-decoration-none">Rate this product</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
